 ...
 */
public class complain_enteryFragment extends Fragment {
    ...
    public complain_enteryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_complain_entery, container, false);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_TAKE_PHOTO) {
                ...
                Glide.with(complain_enteryFragment.this)
                        .load(mPhotoFile)
