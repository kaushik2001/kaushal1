package com.appsnipp.loginsamples.apiinterface.Paytm;

public class Constants {

    public static final String M_ID = "UFMrxD28044714920095"; //Paytm Merchand Id we got it in paytm credentials
